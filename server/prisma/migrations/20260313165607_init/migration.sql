-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SPEAKER', 'REVIEWER', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "Proposal" ADD CONSTRAINT "Proposal_speakerId_fkey" FOREIGN KEY ("speakerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
